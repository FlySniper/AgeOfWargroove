...
function AgeOfWargroove.spawnGlobalStateSoldier()
    ...
    table.insert(trigger.actions, { id = "spawn_global_state_unit", parameters = { }, enabled = true   })
...
function AgeOfWargroove.generateGoldPerTurnFromPosTrigger(referenceTrigger)
    ...
    table.insert(trigger.actions, { id = "generate_gold_per_turn_from_pos", parameters = { "current" }, enabled = true   })
...
function AgeOfWargroove.drawTechLevelEffect(referenceTrigger)
    ...
    table.insert(trigger.actions, { id = "draw_tech_level_effect", parameters = { "current" }, enabled = true   })
...
function AgeOfWargroove.drawMiningCampIndicator(referenceTrigger)
    ...
    table.insert(trigger.actions, { id = "draw_mining_camp_indicator", parameters = {  }, enabled = true   })
...
function AgeOfWargroove.setInitialTechLevel(referenceTrigger)
    ...
    trigger.conditions = {}
    trigger.actions = {}
    table.insert(trigger.actions, { id = "set_tech_level", parameters = { "current", 1}, enabled = true  })
...
function AgeOfWargroove.modifyUnitCapTrigger(referenceTrigger)
    ...
    trigger.conditions = {}
    trigger.actions = {}
    table.insert(trigger.actions, { id = "modify_population_cap", parameters = { "current" }, enabled = true   })
...
function AgeOfWargroove.getReportDeadMineCampTrigger()
    ...
    table.insert(trigger.conditions, { id = "unit_killed", parameters = { "*unit", "current", "gold_camp", "any", "-1" }, enabled = true  })
    table.insert(trigger.conditions, { id = "player_turn", parameters = { "current" }, enabled = true  })

    trigger.actions = {}

    table.insert(trigger.actions, { id = "remove_generate_gold_per_turn_from_pos", parameters = {}, enabled = true  })
...
function AgeOfWargroove.modifyDDoorGroove()
    ...
    trigger.actions = {}
    table.insert(trigger.actions, { id = "modify_dimensional_door_groove", parameters = { }, enabled = true  })
...
function AgeOfWargroove.generateGoldPerTurnFromPos(targetPos, playerId, goldPerTurn)
    ...
    if (goldLeft <= goldPerTurn) then
        table.insert(trigger.actions, { id = "modify_gold", parameters = { "current", "1", goldLeft }, enabled = true  })
        table.insert(trigger.actions, { id = "modify_gold_at_pos", parameters = { targetPos.x, targetPos.y, 2, goldLeft }, enabled = true  })
    else
        table.insert(trigger.actions, { id = "modify_gold", parameters = { "current", "1", goldPerTurn }, enabled = true  })
        table.insert(trigger.actions, { id = "modify_gold_at_pos", parameters = { targetPos.x, targetPos.y, 2, goldPerTurn }, enabled = true  })
    end
