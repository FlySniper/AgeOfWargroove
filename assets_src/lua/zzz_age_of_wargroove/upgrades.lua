...
function Upgrades.modifyUpgradeGroove(referenceTrigger)
    ...
    trigger.actions = {}
    table.insert(trigger.actions, { id = "modify_upgrade_groove", parameters = { "current" }, enabled = true })
...
function Upgrades.modifyUpgradeIndicators(referenceTrigger)
    ...
    table.insert(trigger.conditions, { id = "unit_presence", parameters = { "current", "1", "0", "blacksmith", "-1" }, enabled = true })

    trigger.actions = {}
    table.insert(trigger.actions, { id = "modify_upgrade_indicator", parameters = { "current" }, enabled = true })
...
function Upgrades.reportDeadUpgradeTrigger(referenceTrigger)
    ...
    table.insert(trigger.conditions, { id = "unit_killed", parameters = { "*unit", "current", "blacksmith", "any", "-1" }, enabled = true })
    table.insert(trigger.conditions, { id = "player_turn", parameters = { "current" }, enabled = true })

    trigger.actions = {}

    table.insert(trigger.actions, { id = "upgrade_death_cancel_upgrade", parameters = {"current"}, enabled = true })
