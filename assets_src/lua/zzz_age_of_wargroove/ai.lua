...
local AIUtils = require "zzz_age_of_wargroove/ai_utilities"
...
function AI.modifyAIGlobalsTrigger(referenceTrigger)
    ...
    trigger.actions = {}
    table.insert(trigger.actions, { id = "modify_ai_globals", parameters = { "current" }, enabled = true  })
...
function AI.setupAIHeatMapTrigger(referenceTrigger)
    ...
    table.insert(trigger.conditions, { id = "start_of_turn", parameters = {}, enabled = true })
    trigger.actions = {}
    table.insert(trigger.actions, { id = "setup_ai_heatmap", parameters = { "current" }, enabled = true  })
...
function AI.modifyAIGlobalsAlwaysTrigger(referenceTrigger)
    ...
    trigger.players = referenceTrigger.players
    trigger.conditions = {}
    table.insert(trigger.conditions, { id = "end_of_unit_turn", parameters = { }, enabled = true })
    trigger.actions = {}
    table.insert(trigger.actions, { id = "modify_ai_globals", parameters = { "current" }, enabled = true  })
